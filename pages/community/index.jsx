  ...
  return (
    <React.Fragment>
      ...
      <div className="h-full w-full relative">
        ...
        <div
          className="absolute bottom-20 right-0 bg-pwip-primary text-white text-sm font-sans pl-3 pr-2 py-2 rounded-l-full inline-flex items-center justify-center"
