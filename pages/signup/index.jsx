  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title>Signup | pwip - Export Costing </title>
        ...
        <div className="inline-flex flex-col relative w-full h-full px-5 py-10">
          <div className="inline-flex flex-col justify-start space-y-1 relative">
            ...
            <span className="line-clamp-1 font-regular text-[#77787b] text-md">
              Hello, signup to start using our EC tool.
            </span>
          </div>
          ...
          <div className="w-full inline-flex flex-col space-y-8 relative py-2 px-3 mt-10">
            <div className="inline-flex flex-col w-full space-y-3">
            ...
            <button className="w-full rounded-full py-3 px-4 bg-[#2475c0] text-white text-center text-md font-semibold">
              Request OTP
            </button>
          </div>
          <div
          ...
          >
            <span className="line-clamp-1 font-regular text-[#77787b] text-md">
              Already a member?{" "}
              <span className="text-[#4fb28b] cursor-pointer">Login now.</span>
            </span>
          </div>
        </div>
      </div>
