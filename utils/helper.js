...
export const apiStagePaymentBeUrl = process.env.NEXT_PUBLIC_API_STAGE_PAYMENT_BE_URL;
export const exportCostingServiceId = process.env.NEXT_PUBLIC_API_EXPORT_COSTING_SERVICE_ID;
